...
# Feb 1, 2023
# File Version 5
# Desp: a script to subscribe data from simulators(Namespace/joy): throttle&yoke&Rudder and publish takeoff/velocity/land commands to UAV
...
def callback3(data):
	# Use Rudder to control pitch
	print('##################')

	twist.angular.z = data.axes[2]/2
